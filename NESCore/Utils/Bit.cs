...
public static class Bit
{
    ...
    {
        var bitSet = b >> pos;
        return TestVal(b, pos) == 1;
    }

    /// <summary>
    /// Returns the value of the given position in a byte as a 1 or a 0. Contained in a byte because
    /// that's the smallest type
    /// </summary>
    /// <returns></returns>
    public static byte TestVal(byte b, int pos)
    {
        var bitSet = b >> pos;
        return (byte)(bitSet & 1);
    }
