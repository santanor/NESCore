...
namespace NESCore
{
    public abstract class MemoryBase
    {
        ...
        /// <returns></returns>
        protected byte Byte(ushort address)
        {
            return bank[address];
        }

        protected byte Byte(int address)
        {
        ...
        /// </summary>
        protected ushort Word(ushort address)
        {
        ...
        protected ushort Word(int address)
        {
        ...
        protected void WriteByte(ushort addr, byte value)
        {
            bank[addr] = value;
        }
        ...
        /// <param name="addr"></param>
        /// <param name="value"></param>
        protected void WriteWord(ushort addr, ushort value)
        {
